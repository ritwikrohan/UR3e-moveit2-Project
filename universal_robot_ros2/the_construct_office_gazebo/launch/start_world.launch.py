...
def generate_launch_description():
    ...
    if 'GAZEBO_MODEL_PATH' in os.environ:
        os.environ['GAZEBO_MODEL_PATH'] =  os.environ['GAZEBO_MODEL_PATH'] + ':' + extra_models_path + ':' + autogen_models_path
    else:
        os.environ['GAZEBO_MODEL_PATH'] =  extra_models_path+ ':' + autogen_models_path
